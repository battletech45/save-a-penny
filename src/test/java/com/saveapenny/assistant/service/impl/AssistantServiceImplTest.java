...
class AssistantServiceImplTest {
    ...
    @Test
    void chat_trimsHistoryToConfiguredMaxAndReturnsReply() {
        ...
        assertEquals(4, promptCaptor.getAllValues().getLast().getInstructions().size());
    ...
    void chat_ignoresUnsupportedHistoryRoles() {
        ...
        assertEquals(3, promptCaptor.getAllValues().getLast().getInstructions().size());
    }
